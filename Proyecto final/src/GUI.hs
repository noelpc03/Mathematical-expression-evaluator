...
-- import HexParser (HexExpr, parseHexExpr)
...
--     let switchSystem buttons allowedChars parser = do
--             updateButtonGrid buttons buttonGrid input
--             restrictInput input allowedChars
--             void $ element input # set value ""
--             -- Usar el parser adecuado para cada tipo de entrada
--             on UI.click (head buttonsSwitch) $ \_ -> switchSystem buttonsDecimal (Just "0123456789.,+-*/()^ex") parseDecimalExpr
--             on UI.click (buttonsSwitch !! 1) $ \_ -> switchSystem buttonsBin (Just "01+-*/()") (parse parseExpr "")
--             on UI.click (last buttonsSwitch) $ \_ -> switchSystem buttonsHex (Just "0123456789ABCDEF+-*/()") guiParseHexExpr

--     -- Configurar el sistema de entrada para Decimal inicialmente
--     switchSystem buttonsDecimal (Just "0123456789.,+-*/()^ex") parseDecimalExpr
...
-- -- Parseadores para Decimal y Hexadecimal
-- parseDecimalExpr :: String -> Either ParseError Expr
-- parseDecimalExpr = parse parseExpr ""

-- guiParseHexExpr :: String -> Either ParseError HexExpr
-- guiParseHexExpr = parse parseHexExpr ""