module Binary (binaryToDecimal, decimalToBinary, evalBinOp, sumBin) where
...
sumBin :: String -> String -> String
sumBin bin1 bin2 = decimalToBinary (binaryToDecimal bin1 + binaryToDecimal bin2)

--Función para resta dos cadenas binarias
subBin :: String -> String -> String
subBin bin1 bin2 = decimalToBinary (binaryToDecimal bin1 - binaryToDecimal bin2)
...
evalBinOp "+b" x y = sumBin x y
evalBinOp "-b" x y = subBin x y
